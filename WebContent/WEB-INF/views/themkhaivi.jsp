...
<body>
  ...
  <%@include file="../../common/admin/slider.jsp"%>
	...
	<div class="d-flex"> 
	<a href="../user/addkhaivi.htm" class="btn btn-success btn-block m-5 w-25 ">Thêm Khai Vị</a>
	<a href="../user/fixkhaivi.htm" class="btn btn-primary btn-block m-5 w-25 ">Sửa Khai Vị</a>
	</div>					
	    	<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						...
						<td>
						<p>${l.tenmonan }</p>
						<img alt="" src="../load/khaivi/${l.hinhanh}" style="width:100px;height:100px">
