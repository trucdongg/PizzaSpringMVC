...
<%@include file="../../common/trangchu/navmenu.jsp"%>
      <!-- /.col-lg-3 -->
		<div class="col-12 w-100 mt-5">
			<img src="../resources/trangchu/img/header-rice.jpg" alt="banner" width="100%">
		</div>
      <div class="col-lg-12">
        <div class="row mt-5">
		...
		<div class="product col-lg-6 col-md-6 mb-5 ">
            <div class="d-flex black h-100">
              <a href="#" class="col-6" style="width: 180px;height:180px;"><img class="card-img-top" src="../load/miy/${l.hinhanh}" width="100%" height="100%"></a>
