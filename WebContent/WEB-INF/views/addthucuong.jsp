 ...
 <%@include file="../../common/admin/slider.jsp"%>
    ...
    <div id="page-content-wrapper">
 	...
 	${message}
         ...
         <h2 class="mt-2">Thêm Thức Uống</h2>
  <form:form method="POST" modelAttribute="monan" action="../user/addthucuong.htm" enctype="multipart/form-data" >
  <div class="form-group">
      <label for="tenmonan">Tên Thức Uống</label>
      <form:input type="text" class="form-control w-50" name="tenmonan"  path="tenmonan" />
    </div>
    <div class="form-group" style="font-size:20px;color:red;">
 	 <form:errors path="tenmonan" />
		</div>
    <div class="form-group">
      <label for="mota">Mô Tả</label>
      <form:input type="text" class="form-control w-50" name="mota"  path="mota" />
    </div>
    <div class="form-group" style="font-size:20px;color:red;">
      ...
      <form:input type="number" class="form-control w-50" name="soluong"  path="soluong" />
    </div>
    <div class="form-group" style="font-size:20px;color:red;">
      ...
      <form:input type="number" class="form-control w-50" name="giatien"  path="giatien" />
    </div>
    <div class="form-group" style="font-size:20px;color:red;">
 	 <form:errors path="giatien" />
		</div>
		<div class="form-group">
