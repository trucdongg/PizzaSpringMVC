...
<body>
 ...
 <%@include file="../../common/admin/slider.jsp"%>
    ...
    <div id="page-content-wrapper">
 	...
 	${message}
         ...
         <h2 class="mt-2">Sửa Mì Ý</h2>
 	<form method="POST" action="../user/fixmiy.htm" enctype="multipart/form-data">
  <div class="form-group">
      <label for="ten">Tên Mì Ý</label>
      <br>
         <select class="browser-default custom-select w-50" name="miy">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
   <img src="../load/miy/thitbamsotca.png" id="output" alt="..." class="img-responsive" style="width:200px;height:200px"/>	
 ...
 <div class="form-group">
  ...
  $("#menu-toggle").click(function(e) {
    		 ...
    		 $.ajax({
                 ...
                 success: function(d) {
                    ...
                    $('input[name="mota"]').val(data[1]);
                   	$('#output').attr('src','../load/miy/'+data[2]);
    ...
    $('select[name="miy"]').on('change',function(){
    	var id= $(this).val();
    	if(id != null)
    		{
    		console.log(id)
