  ...
  <div class="d-flex" id="wrapper">
    ...
    <tbody>
      <tr>
        ...
        <td>${l.sdt }</td>
        <td>
	<button type="button" role="accept" id="${l.id_giohang }" class="btn btn-primary">Duyệt</button>
	<button type="button" role="deny" id="${l.id_giohang }" class="btn btn-danger">Từ Chối</button>
		</td>
		 <td><a href="../user/chitiet.htm?id=${l.id_giohang }">Chi Tiết</a></td>
      </tr>
