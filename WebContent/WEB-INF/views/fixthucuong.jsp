...
<body>
 ...
 <%@include file="../../common/admin/slider.jsp"%>
    ...
    <div id="page-content-wrapper">
 	...
 	${message}
         ...
         <h2 class="mt-2">Sửa Thức Uống</h2>
 	<form method="POST" action="../user/fixthucuong.htm" enctype="multipart/form-data">
  <div class="form-group">
      <label for="ten">Tên Thức Uống</label>
      <br>
         <select class="browser-default custom-select w-50" name="thucuong">
 ...
 <div class="form-group">
      ...
      <input type="text" pattern="[a-z0-9A-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ, ]+"
       class="form-control w-50" name="tenmonan"  placeholder="Tên Món Ăn" required/>
    </div>
   <div class="form-group">
      <label for="mota">Mô Tả</label>
      <input type="text" pattern="[a-z0-9.A-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ, ]+" 
      class="form-control w-50" name="mota"  placeholder="Mô Tả" required/>
    </div> 
   <div class="form-group">
   <img src="../load/thucuong/coca.png" id="output" alt="..." class="img-responsive" style="width:200px;height:200px"/>	
 ...
 <div class="form-group">
  ...
  $("#menu-toggle").click(function(e) {
    		 ...
    		 $.ajax({
                 ...
                 success: function(d) {
                    ...
                    $('input[name="mota"]').val(data[1]);
                   	$('#output').attr('src','../load/thucuong/'+data[2]);
    ...
    $('select[name="thucuong"]').on('change',function(){
    	var id= $(this).val();
    	if(id != null)
    		{
    		console.log(id)
