 ...
 <%@include file="../../common/admin/slider.jsp"%>
    ...
    <div id="page-content-wrapper">
 	...
 	${message}
         ...
         <h2 class="mt-2">Thêm Khai Vị</h2>
  <form:form method="POST" modelAttribute="monan" action="../user/addkhaivi.htm" enctype="multipart/form-data" >
  <div class="form-group">
      <label for="tenmonan">Tên Khai Vị</label>
