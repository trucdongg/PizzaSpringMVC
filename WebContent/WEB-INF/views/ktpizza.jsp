 ...
 <%@include file="../../common/admin/slider.jsp"%>
    ...
    <div id="page-content-wrapper">
 	...
 	${message}
         ...
         <h2 class="mt-2">Thêm Kích Thước</h2>
 	<form method="POST" action="../user/addktpizza.htm" id="addkt">
      ...
      if( $('select[name="piz"]').val() != null)
       $.ajax({
          	...
          	success: function(d){
          		...
          		$('button[role="xacnhan"]').hide();
          		}
          		else{
          			$('input[name="gia"]').val(0);
              		$('input[name="soluong"]').val(0);
              		$('button[role="xacnhan"]').show();
          		}
          	},error: function(e){
          		console.log("Chưa có");
          	}	
       })
       // Nếu không có select value = cái tên pizza nào
       else{
