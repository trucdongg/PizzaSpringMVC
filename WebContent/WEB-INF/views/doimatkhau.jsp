...
<%@include file="../../common/trangchu/header.jsp"%>
  ...
  <form:form method="POST" action="" >
    <div class="form-group">
      <label for="matkhauht">Mật Khẩu Hiện Tại</label>
      <input type="password" class="form-control" name="matkhauht" required >
    </div>
    <div class="form-group">
      <label for="matkhaunew">Mật Khẩu Mới</label>
      <input type="password" class="form-control" name="matkhaunew" required>
    </div>
  <div class="form-group">
      <label for="rematkhaunew">Nhập Lại Mật Khẩu Mới</label>
      <input type="password" class="form-control" name="rematkhaunew" required>
    </div>
