...
<body>
  ...
  <%@include file="../../common/admin/slider.jsp"%>
	...
	<div class="d-flex"> 
	<a href="../user/addthucuong.htm" class="btn btn-success btn-block m-5 w-25 ">Thêm Thức Uống</a>
	<a href="../user/fixthucuong.htm" class="btn btn-primary btn-block m-5 w-25 ">Sửa Thức Uống</a>
	</div>					
	    	<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						...
						<td>
						<p>${l.tenmonan }</p>
						<img alt="" src="../load/thucuong/${l.hinhanh}" style="width:100px;height:100px">
